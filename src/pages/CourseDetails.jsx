      ...
      <div className={`relative w-full bg-richblack-800`}>
        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            >
              <div>
                <p className="text-3xl sm:text-4xl font-bold text-richblack-5 sm:text-[42px]">
                  {courseName}
                </p>
              </div>
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          ...
          <div className="my-8 border border-richblack-600 p-4 sm:p-8">
            <p className="text-2xl sm:text-3xl font-semibold">What you'll learn</p>
          ...
          <div className="max-w-[830px] ">
            <div className="flex flex-col gap-3">
              <p className="text-[24px] sm:text-[28px] font-semibold">Course Content</p>
              <div className="flex flex-wrap justify-between gap-2">
                ...
                <div>
                  <button
                    className="text-yellow-25 text-sm sm:text-base"
                    onClick={() => setIsActive([])}
                  >
            ...
            <div className="mb-12 py-4">
              <p className="text-[24px] sm:text-[28px] font-semibold">Author</p>
